...
import (
	...
	"github.com/prometheus/alertmanager/api/v1/restapi/operations"
	"github.com/prometheus/alertmanager/api/v1/restapi/operations/alert"
	"github.com/prometheus/alertmanager/api/v1/restapi/operations/alertgroup"
	"github.com/prometheus/alertmanager/api/v1/restapi/operations/general"
	"github.com/prometheus/alertmanager/api/v1/restapi/operations/receiver"
	"github.com/prometheus/alertmanager/api/v1/restapi/operations/silence"
)

//go:generate swagger generate server --target ../../v1 --name AlertmanagerAPI --spec ../../v2/openapi.yaml --principal interface{} --exclude-main

func configureFlags(api *operations.AlertmanagerAPIAPI) {
	// api.CommandLineOptionsGroups = []swag.CommandLineOptionsGroup{ ... }
}

func configureAPI(api *operations.AlertmanagerAPIAPI) http.Handler {
